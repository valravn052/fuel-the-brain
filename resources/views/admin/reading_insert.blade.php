...
@section('content')
    ...
    <form action="{{ route('reading_insert-submit') }}" method="post">
        @csrf
        <div class="service-section mb-2 pt-2 pl-3 border border-secondary">
            <h4 class="text-center">Insert Questions</h4>
            
        </div>
        
        <h5>Comprehension: </h5>
        <div class="form-floating mb-2">
            <textarea class="form-control" placeholder="Write the comprehension" name="comprehension" style="height: 50px"></textarea>
        </div><br>
